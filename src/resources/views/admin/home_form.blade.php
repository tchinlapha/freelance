...
<div class="col-md-12 panel panel-flat">
    <div class="panel-heading">
        <h2 class="panel-title"><i class="icon-plus-circle2"></i> เพิ่มสไลด์</h2>
    </div>
    <div class="panel-body">
        <form action="/admin/home/add" method="post" enctype="multipart/form-data">
           {{ csrf_field() }}
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="thumbnail">
                <div class="thumb">
                    <a href="/admin/home/image/delete/{{$val->id}}" onclick="return confirm('ต้องการลบใช่หรือไม่?');" class="btn btn-danger" style="position: absolute;top:0;right: 0;"><i class="icon-bin"></i></a>
