...
function toggleSidebar() {
	$(".menu-side-menu").show();
	var chk = $(".menu-side-menu").hasClass("slideInLeft");
	if (chk) {
		$(".menu-side-menu").removeClass("slideInLeft");
		$(".menu-side-menu").addClass("slideOutLeft");
	} else {
		$(".menu-side-menu").removeClass("slideOutLeft");
		$(".menu-side-menu").addClass("slideInLeft");
	}
